...
*downbeat* stay locked for the entire track with **no time-warping** ΓÇö exactly
...
def manual_grid_shift(
    ...
    guessing ΓÇö the DJ nudges from here.
...
def place_vocal(
    ...
    # instrumental (>= COVER of the vocal inside the track) ΓÇö otherwise a tiny
    ...
    # track ΓÇö a vocal/beat energy correlation is weak, so a distant sliver must
